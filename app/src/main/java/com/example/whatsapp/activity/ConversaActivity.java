...
public class ConversaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editMensagem = findViewById(R.id.edit_text_mensagem);
        buttonEnviar = findViewById(R.id.button_enviar_mensagem);
        listView     = findViewById(R.id.list_view_conversa);
        ...
        //monta listvew e adapter
        mensagens = new ArrayList<>();
        adapter = new MensagemAdapter(ConversaActivity.this, mensagens);
        listView.setAdapter( adapter );

        //recuperar mensagens do firbase
                ...
                if (textoMensagem.isEmpty()){
                    ...
                    if ( !retornoMensagemRemetente ){
                        ...
                        if ( !retornoMensagemDestinatario ){
                            Toast.makeText(ConversaActivity.this,"Problema ao enviar para este destinatario, tente novamente",Toast.LENGTH_LONG).show();
                        }
                    }
                    ...
                    if( !retornoConversaRemetente ){
                        ...
                        if ( !retornoConversaDestinatario ){
                            ...
                            Toast.makeText(ConversaActivity.this, "Problema em salvar convesa para o destinatario, tente novamente",Toast.LENGTH_LONG).show();
                        }
                    }
